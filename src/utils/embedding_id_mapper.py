...
class IDMapper:
    def __init__(self):
        ...
        self.item_to_index = {}
        self.index_to_item = []
        self.unkown_user_index = -1
        self.unkown_item_index = -1
    ...
    def fit(self, user_ids, item_ids):
        ...
        self.unkown_user_index = len(self.user_to_index)
        self.unkown_item_index = len(self.item_to_index)

    def get_user_index(self, user_id):
        return self.user_to_index.get(user_id, self.unkown_user_index)
    
    def get_item_index(self, item_id):
        return self.item_to_index.get(item_id, self.unkown_item_index)
